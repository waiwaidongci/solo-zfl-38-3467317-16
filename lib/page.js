...
$("#registerForm").onsubmit=function(e){
  e.preventDefault();
  var f=e.target, o=Object.fromEntries(new FormData(f).entries());
  api("/api/ropes",{method:"POST",body:JSON.stringify(o)}).then(function(){ f.reset(); updateHint(); return loadRopes(); })
...
$("#cycleForm").onsubmit=function(e){
  ...
  fd.expectedSeq=r.cycles.length+1;
  api("/api/ropes/"+encodeURIComponent(id)+"/cycles",{method:"POST",body:JSON.stringify(fd)})
